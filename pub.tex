\section{Publicaciones y proyectos}
\vspace{2em}

% Reducir espacio vertical localmente dentro de esta sección (override del parskip global)
...
\pub{Oct. 2024}{Bootloaders AADECA}{}{Charla sobre bootloades en el marco del evento de AADECA sobre ciberseguridad. Facultad de Ingeniería del Ejército.}{
}
...
% Fin del bloque con parskip reducido
\endgroup
